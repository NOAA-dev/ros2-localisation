...
class KalmanFilterNode(Node):
    ...
    def __init__(self):
        ...
        self.odom_sub_ = self.create_subscription(Odometry, "bumper_bot/odom_noisy", self.odomCallback, 10)
        self.imu_sub_ = self.create_subscription(Imu, "/imu", self.imuCallback, 10)
        self.odom_pub_ = self.create_publisher(Odometry, "bumper_bot/odom_kalman", 10)
